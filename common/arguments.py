...
def get_common_args():
    ...
    parser.add_argument('--pretrain_dir', type=str, default='./model', help='model directory of the policy')
    parser.add_argument('--model_dir', type=str, default='./model_attack', help='model directory of the policy')
    parser.add_argument('--result_dir', type=str, default='./result_attack', help='result directory of the policy')
